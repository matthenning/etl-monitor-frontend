<template>
    ...
    <div>
        ...
        <v-row>
            <v-col>
                <sla-list-selector ref="selector"></sla-list-selector>
            </v-col>
        </v-row>
        ...
        <deliverable-sla-definition-sla-data-table v-if="object" :definition-id="object.id"></deliverable-sla-definition-sla-data-table>
...
import DeliverableSlaDefinitionSlaDataTable from "@/components/tables/DeliverableSlaDefinitionSlaDataTable";
...
export default {
    components: {SlaListSelector, DeliverableSlaDefinitionSlaDataTable},
